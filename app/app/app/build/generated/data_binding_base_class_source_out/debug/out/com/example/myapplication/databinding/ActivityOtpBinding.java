...
public final class ActivityOtpBinding implements ViewBinding {
  ...
  @NonNull
  public final LinearLayout emailVerify;
  ...
  private ActivityOtpBinding(@NonNull RelativeLayout rootView, @NonNull ImageButton buttonGoback,
      @NonNull Button buttonNext, @NonNull EditText code1, @NonNull EditText code2,
      @NonNull EditText code3, @NonNull EditText code4, @NonNull LinearLayout emailVerify,
      @NonNull LinearLayout otpCode, @NonNull TextView textResend) {
  ...
  public static ActivityOtpBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.email_verify;
      LinearLayout emailVerify = ViewBindings.findChildViewById(rootView, id);
      if (emailVerify == null) {
        break missingId;
      }
      ...
      return new ActivityOtpBinding((RelativeLayout) rootView, buttonGoback, buttonNext, code1,
          code2, code3, code4, emailVerify, otpCode, textResend);
    }
